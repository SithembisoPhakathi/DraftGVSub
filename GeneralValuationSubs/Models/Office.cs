...
public partial class Office
{
    ...
    public string? Nla1 { get; set; }

    public string? Nla2 { get; set; }

    public string? Nla3 { get; set; }

    public string? BasementParking { get; set; }

    public string? Carport { get; set; }

    public string? OpenParking { get; set; }

    public string? NoOfStoreys { get; set; }

    public string? TotalLettableArea { get; set; }
