...
public partial class UpdatedGvtoolContext : DbContext
{
    public UpdatedGvtoolContext()
    {
    }

    public UpdatedGvtoolContext(DbContextOptions<UpdatedGvtoolContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.Property(e => e.CatEndDate).HasColumnName("CAT_END_DATE");
            entity.Property(e => e.CatId).HasColumnName("CAT_ID");
            entity.Property(e => e.CatStartDate).HasColumnName("CAT_START_DATE");
